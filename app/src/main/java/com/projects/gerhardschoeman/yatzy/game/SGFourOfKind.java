...
public class SGFourOfKind extends ScoreGroup {
    ...
    public int getScore(int d1, int d2, int d3, int d4, int d5, ArrayList<ScoreGroup> availableMoves) {
        ...
        if(ones>3) predictedScore = ones*1;
        else if(twos>3) predictedScore = twos*2;
        else if(threes>3) predictedScore = threes*3;
        else if(fours>3) predictedScore = fours*4;
        else if(fives>3) predictedScore = fives*5;
        else if(sixes>3) predictedScore = sixes*6;
